...
class PieGraph extends React.Component {
    ...
    getOption = () => {
        ...
        const legendOption = {
            ...
            formatter(name) {
                const res = echartData.filter((v) => v.name === name);
